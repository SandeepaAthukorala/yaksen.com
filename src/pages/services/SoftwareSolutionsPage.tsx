        ...
        >
          <div className="text-center">
            ...
            <p className="text-xl text-neutral-300 max-w-3xl mx-auto leading-relaxed">
              <span className="text-primary-400 font-semibold">Tailored software solutions</span> designed to address your specific business needs, streamline operations, and drive growth.
            </p>
          </div>
        </motion.div>
      </div>
        ...
        >
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-neutral-900 dark:text-white mb-6">
              Custom Software for <span className="gradient-text">Modern Businesses</span>
            </h2>
            <p className="text-xl lg:text-2xl text-neutral-600 dark:text-neutral-300 leading-relaxed">
              We develop <span className="text-primary-500 font-semibold">bespoke software solutions</span> that solve your unique business challenges and give you a <span className="text-secondary-500 font-semibold">competitive edge</span>.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <section className="section-padding bg-gradient-to-br from-neutral-50 via-white to-neutral-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl lg:text-2xl text-neutral-600 dark:text-neutral-300 leading-relaxed">
              Let's discuss your software solution needs and create something amazing together.
            </p>
          </div>
