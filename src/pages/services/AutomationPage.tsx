        ...
        >
          <div className="text-center">
            ...
            <p className="text-xl text-neutral-300 max-w-3xl mx-auto leading-relaxed">
              Identify inefficiencies in your workflows and implement automation solutions to <span className="text-primary-400 font-semibold">increase productivity</span> and <span className="text-secondary-400 font-semibold">reduce operational costs</span>.
            </p>
          </div>
        </motion.div>
      </div>
        ...
        >
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl lg:text-2xl text-neutral-600 dark:text-neutral-300 leading-relaxed">
              We help businesses identify bottlenecks, automate repetitive tasks, and optimize workflows to <span className="text-primary-500 font-semibold">save time</span> and <span className="text-secondary-500 font-semibold">resources</span>.
            </p>
          </div>
        </motion.div>
      </section>
          ...
          >
            {[
              ...
              return (
                ...
                >
                  <div className="card card-hover h-full p-8 relative overflow-hidden group cursor-pointer">
                    {/* Background Pattern */}
      ...
      <section className="section-padding bg-gradient-to-br from-neutral-50 via-white to-neutral-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
        ...
        >
          ...
          <div className="card p-8">
            <PackageInquiryForm serviceType="Process Automation" />
          </div>
        </motion.div>
      </section>
